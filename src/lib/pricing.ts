...
export const PLANS: Record<PlanId, Plan> = {
  ...
  premium: {
    ...
    standardPrice: 9,
    tagline:
      'Genius Mining: a guided session that names how you actually think, plus everything in Basic.',
    shortTagline: 'Genius Mining, plus everything in Basic.',
    features: [
      'Everything in Basic, plus:',
      'Genius Mining: the full 40-minute instrument',
      'Your working word and the evidence behind it',
      'A one-page printout you can take to an advisor',
      'Edit and refine your profile all year',
      'Your answers deleted on request, always',
    ],
    cta: 'Go Premium',
  },
  club: {
    ...
    shortTagline: 'Full club page toolkit.',
    features: [
